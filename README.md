...
1. `questsAreFun`: A simple function with a specific area for execution.
1. `init`: The constructor function initializes the contract and creates an instance of `SomeStruct` as `testStruct`.
